...
export const projects: ProjectDetails[] = [
    ...
    },
    {
        ...
        techStack: ["React v18", "Vite", "TypeScript", "Zustand", "React Query", "Keycloak", "Tailwind CSS", "Axios"],
        challenges: [
            {
                title: "이미지 처리 최적화",
        ...
        features: ["도면 이미지 업로드 및 OCR 처리", "텍스트 영역 시각화", "로그 관리 및 분석", "사용자 권한 관리"],
    },
    {
        id: 3,
        title: "경기데이터 찾아드림",
        ...
        features: ["AI 챗봇 인터페이스", "실시간 응답 스트리밍", "데이터 시각화", "반응형 디자인"],
    ...
    },
    {
        ...
        features: ["NIFI 프로세스 모니터링", "실시간 상태 대시보드", "프로세스 관리 및 제어", "에러 로그 분석"],
    ...
    },
    {
        ...
        description:
            "기존 HTML 기반 챗봇 서비스를 React + TypeScript 환경으로 리팩토링하고, LLM 설정 기능을 점진적으로 확장",
        ...
        techStack: ["React", "Vite", "TypeScript", "Zustand", "React Query", "Keycloak", "Tailwind CSS", "ky", "fetch"],
        challenges: [
            {
                title: "레거시 코드 마이그레이션",
            ...
            },
            {
                ...
                description:
                    "프로젝트 초기에는 단순 대화 UI만 제공했으나, 2024년부터 모델 설정, 프롬프트 관리, RAG 기능 등 고도화 요구사항이 추가되었습니다.",
                solution: "유연한 구조 설계를 기반으로 MCP, 모델/RAG 설정 UI 및 관리 기능을 점진적으로 통합했습니다.",
            },
        ],
        features: ["모던 챗봇 인터페이스", "실시간 응답 처리", "LLM 설정 관리", "사용자 인증 및 권한 제어"],
